            ...
            <body class="h7"> <br><br><br>
                ...
                <div id="page">
                    ...
                    <tr><td><div class="h7" align="left" style="font-size: 15px; color: white;">NOMBRE DEL PROYECTO: 
                            <input type="text" placeholder="Proyecto" name="proyecto" class="caja"></div> </td></tr><br></table>
...
<?php } ?>
                ...
                <tr>
                    <td width="50%" align=left class="h8">
                        ...
                        VIGENCIA EN D&Iacute;AS: <input class="caja" type="text" placeholder="No vigencia en días" name="vigencia"><br>
                                        
                        TIEMPO DE ENTREGA: <input class="caja" type="text" placeholder="Tiempo de entrega" name="t_entrega"  align="center"><br>
                                        
                        L.A.B. AREA METROPOLITANA<br>
                                        
                        CONDICIONES DE PAGO: <input class="caja" type="text" placeholder="Condiciones de pago" name="c_pago"  align="center">
                                        <br><br>                                        
                        ...
                        <div align="center">
                            <input  type="text" class="cajota"  name="datos_vendedor" value="<?php echo "$nombre"; ?>"><br> 
                    ...
                    <td>
                        <div align='center'><textarea  type="text" class="cajota"  name="datos_vendedor2" rows="1" cols="28"><?php echo "$e_mail" . " $telefonoo1" . " $telefonoo2"; ?></textarea></div>
                    </td>
