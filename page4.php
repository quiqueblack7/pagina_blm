...
<title>Best Light Mexico - Parque Lineal</title>
...
<table width="877" cellspacing="1" cellpadding="1" border="0" align="center">
    <tbody>
        <tr>
            <td style="text-align: center;"><img width="475" height="282" alt="" src="attachments/Image/Parque_lineal_Puebla.jpg" /><br />
            <span style="font-size: large;"><span style="font-family: Courier New;">Parque Lineal - Puebla <br />
            EG-320</span></span><span style="font-size: large;">             </span></td>
            ...
            <strong><span lang="es" id="result_box"><span><a onclick="window.open(this.href,'','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=800,height=1000,status'); return false" href="attachments/File/borcuhrs">BLM-320 </a></span></span></strong></div>
